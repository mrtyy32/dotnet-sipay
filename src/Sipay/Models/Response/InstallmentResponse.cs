...
namespace Sipay.Models.Response.Installment
{
	public partial class InstallmentResponse
	{
		...
		[JsonProperty("data")]
		public InstallmentData Data { get; set; }
	}
	...
	public partial class InstallmentResponse
	{
		public static InstallmentResponse FromJson(string json) => JsonConvert.DeserializeObject<InstallmentResponse>(json, Converter.Settings);
	}

	public static class Serialize
	{
		public static string ToJson(this InstallmentResponse self) => JsonConvert.SerializeObject(self, Converter.Settings);
